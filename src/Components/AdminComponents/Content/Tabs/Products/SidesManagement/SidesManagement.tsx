...
const SidesManagement = () => {
  ...
  return (
    ...
    >
      {loading ? (
        <Spinner className='sidesManagement__spinner' />
      ) : (
        <div className='sidesManagement__categories'>
          ...
          <ul className='sidesManagement__list'>
            {categories !== null &&
              categories.map((item) => {
                return (
                  <li key={item._id} className='sidesManagement__list-item'>
                    ...
                    <div className='sidesManagement__actions'>
                      <button
                        className='sidesManagement__btn removeBtn'
